...
vgui.Register("singularityPlayerMenu", PANEL, "DFrame")
PLAYER_MENU = PLAYER_MENU or nil

hook.Add("PlayerButtonDown", "singularityPlayerMenuOpen", function(_,btn)
	if btn == KEY_F4 then
		PLAYER_MENU = PLAYER_MENU or vgui.Create("singularityPlayerMenu")
	end
end)

concommand.Add("singularity_debug_fix_playermenu", function()
	PLAYER_MENU = nil
end)